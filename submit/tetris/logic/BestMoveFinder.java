...
public class BestMoveFinder {
    ...
    public static final ParameterWeights BEST_PARAMETERS = new ParameterWeights()
            .put(BAD_CNT, 5.582919899887908).put(HOLE_CNT, 1.889763086518398).put(HEIGHT, 1.4631383737117991).put(SEMI_BAD_CNT, 1.9337455987205074).put(SCORE, -0.716393996010999).put(HEIGHT_POW, 5.005283588122904).put(CELLS_ABOVE_TOP, 0.05887754151955771).put(FLAT_RATE, 0.3).put(COMBO, -1.295997354590228).put(PREV_STATE, 0.2).put(SKIP_CNT, -3).put(T_SPIN_PATTERN, -6).put(SEMI_T_SPIN_PATTERN, -0.670110825807111).put(LOW_EFFICIENCY, 1.5).put(MONOTONIC_RATE, 0.7);
